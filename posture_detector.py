...
class PostureDetector:
    ...
    def __init__(self, buffer_size: int = 10, scale_factor: float = 1.1, min_neighbors: int = 5) -> None:
        ...
        if not self.CASCADE_PATH:  # Check cascade path exists
        ...
        self.min_neighbors = min_neighbors  # Set detection threshold neighbor count filters bounds range value setting
