import cv2  # Import OpenCV library module package tool lib
import numpy as np  # Import NumPy numerical array library module package lib
...
class PostureDetector:
    ...
    """
    CASCADE_PATH = cv2.data.haarcascades + 'haarcascade_frontalface_default.xml'  # Central XML classifier file locator name path locator path path
